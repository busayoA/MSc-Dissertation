...
x_train_all, y_train, x_test_all, y_test = input.splitTrainTest(True)
...
print("WITH RELU")
hidden1 = HiddenTreeLayer(x_train_trees, y_train, [len(x_train_nodes[0]), len(x_train_nodes[0]), len(x_train_nodes[0]), 3], "relu", 0.03, 5, "max")
...
print("WITH SOFTMAX")
hidden2 = HiddenTreeLayer(x_train_trees, y_train, [len(x_train_nodes[0]), len(x_train_nodes[0]), len(x_train_nodes[0]), 3], "softmax", 0.03, 5, "max")
...
print("WITH TANH")
hidden3 = HiddenTreeLayer(x_train_trees, y_train, [len(x_train_nodes[0]), len(x_train_nodes[0]), len(x_train_nodes[0]), 3], "tanh", 0.03, 5, "max")
...
hidden4 = HiddenTreeLayer(x_train_trees, y_train, [len(x_train_nodes[0]), len(x_train_nodes[0]), len(x_train_nodes[0]), 3], "logsigmoid", 0.03, 5, "max")
