...
""" RUN THE PADDED UNHASHED MODEL """
x_train, y_train, x_test, y_test = dp.getData(True, False)
# USING RELU ACTIVATION
print("WITH RELU")
hidden1 = PaddedTreeRNN(x_train, y_train, [311, 64, 2], "relu", 0.03, 5)
hidden1.runModel(x_train, y_train, x_test, y_test)

# USING SOFTMAX ACTIVATION
print("WITH SOFTMAX")
hidden2 = PaddedTreeRNN(x_train, y_train, [311, 64, 2], "softmax", 0.03, 5)
hidden2.runModel(x_train, y_train, x_test, y_test)

# USING TANH ACTIVATION
print("WITH TANH")
hidden3 = PaddedTreeRNN(x_train, y_train, [311, 64, 2], "tanh", 0.03, 5)
hidden3.runModel(x_train, y_train, x_test, y_test)

# USING LOGARITHMIC SIGMOID ACTIVATION
print("WITH LOGARITHMIC SIGMOID")
hidden4 = PaddedTreeRNN(x_train, y_train, [311, 64, 2], "logsigmoid", 0.03, 5)
hidden4.runModel(x_train, y_train, x_test, y_test)
