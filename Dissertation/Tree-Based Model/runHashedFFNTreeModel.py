...
model1a = TreeRNN(x_train, y_train, [10, 64, 64, 2], "relu", 0.05, 30)
...
model1b = TreeRNN(x_train, y_train, [10, 64, 64, 2], "tanh", 0.05, 30)
...
model1c = TreeRNN(x_train, y_train, [10, 64, 64, 2], "logsigmoid", 0.05, 30)
...
model2a = TreeRNN(x_train, y_train, [10, 64, 64, 2], "relu", 0.05, 30)
...
model2b = TreeRNN(x_train, y_train, [10, 64, 64, 2], "tanh", 0.05, 30)
...
model2c = TreeRNN(x_train, y_train, [10, 64, 64, 2], "logsigmoid", 0.05, 30)
