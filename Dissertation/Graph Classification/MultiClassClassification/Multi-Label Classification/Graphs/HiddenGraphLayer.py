...
class HiddenGraphLayer():
    def __init__(self, learningRate, layerName: str, activationFunction: str, neurons:int, dropoutRate: float =  None, 
    hiddenLayerCount: int = None, hiddenLayerUnits: List[int] = None):
